...
COPY target/demo-linkaja-0.0.1-SNAPSHOT.jar /services/demo-linkaja/
...
ENTRYPOINT ["sh", "-c", "java -jar demo-linkaja-0.0.1-SNAPSHOT.jar --server.port=8080 --app.rest-read-timeout=50000"]
